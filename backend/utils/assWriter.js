...
export function generateASSHeader(styles = {}) {
  ...
  return [
    '[Script Info]',
    '; Script generated by BHYND',
    'Title: BHYND Subtitles',
    'ScriptType: v4.00+',
    'WrapStyle: 0',
    'PlayResX: 1080',
...
export function generateUnifiedShadowASSHeader(resolvedStyle = {}) {
  ...
  return [
    '[Script Info]',
    '; BHYND — Unified Shadow silhouette track (blurred/offset as a whole by ffmpeg, see burnSubtitles)',
    'Title: BHYND Unified Shadow',
    'ScriptType: v4.00+',
    'WrapStyle: 0',
    'PlayResX: 1080',
    'PlayResY: 1920',
